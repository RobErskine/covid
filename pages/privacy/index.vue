...
<template>
  <div class="w-full p-4 pt-12 pb-12 max-w-4xl mx-auto">
   <div class="iub_header">
      <h1>Privacy Policy of 
         <strong>covidcasesbythenumbers.com</strong>
      </h1>
   ...
   <div class="one_line_col">
      ...
      <p>Rob Erskine</p>
      <p>
         <b>Owner contact email:</b> rob@roberskine.com
      </p>
   </div>
   <div class="one_line_col">
      <h2 id="types_of_data">
      ...
      <ul class="for_boxes">
         <li>
            <div class="box_primary box_10 expand collapsed">
               <h3 class="expand-click w_icon_24 policyicon_purpose_8050746">Analytics</h3>
   ...
   <div class="iub_footer">
      <p>Latest update: February 27, 2021</p>
   </div>
   <!-- /footer -->
</div>
</template>